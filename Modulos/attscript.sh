...
fun_atts () {
  ...
  [[ -e /tmp/att ]] && rm /tmp/att
	...
	wget -c -P /home https://raw.githubusercontent.com/henrysc10/SSHPLUS//master/Install/versao
...
echo -e "                              \033[1;31mBy Henry\033[1;36m"
...
[[ "$vrs1" == "$vrs2" ]] && {
  ...
  if [[ "$res" = s || "$res" = S ]];then
    ...
    wget hhttps://raw.githubusercontent.com/henrysc10/SSHPLUS//master/Plus > /dev/null 2>&1
